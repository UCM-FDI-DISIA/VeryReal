...
void VeryReal::UiSpriteRenderer::setSpriteTransform(VeryReal::Vector2 pos, VeryReal::Vector2 dimension) {
...
bool UiSpriteRenderer::InitComponent(std::string name, std::string material, int order = 0) { 
    ...
    setSpriteTransform(transform->getPosition(), transform->getSize());
    overlay->add2D(sprite);
